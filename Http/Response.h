...
namespace Rt2::Http
{
    ...
    {
    private:
        Sockets::Net::Socket _sock;

        static void writeCode(OStream& out, int code);
        static void writeContent(OStream& out, const String& content, const ContentType& contentType);
